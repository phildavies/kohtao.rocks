  ...
  <div class="container">
    <?php if ( get_theme_mod('scuba_diving_sport_header_page_title' , true)) : ?>
        ...
        <div class="headerimgbox-meta">
          ...
          <?php endwhile; ?>
          <span class="ms-3"><i class="far fa-comments me-2"></i> <?php comments_number( esc_attr('0', 'scuba-diving-sport'), esc_attr('0', 'scuba-diving-sport'), esc_attr('%', 'scuba-diving-sport') ); ?> <?php esc_html_e('comments','scuba-diving-sport'); ?></span>
        </div>
    <?php endif; ?>
      ...
      <div class="col-lg-8 col-md-8">
        <?php
          while ( have_posts() ) :
            ...
            comments_template();
            if(get_theme_mod('scuba_diving_sport_show_related_post', true )== true):
